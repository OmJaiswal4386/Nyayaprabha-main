      ...
      <div class="mt-6 flex flex-1 flex-col justify-between">
        <nav class="-mx-3 space-y-6 ">
          <div class="space-y-3 ">
            ...
            <a class="flex transform items-center rounded-lg px-3 py-2 text-gray-600 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700"
            ...
            <a class="flex transform items-center rounded-lg px-3 py-2 text-gray-600 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700"
              ...
              <img width="20" height="20" src="https://img.icons8.com/material-outlined/24/admin-settings-male.png"
          ...
          <div class="mt-6 flex flex-1 flex-col justify-between">
            <nav class="-mx-1 space-y-6 ">
              <div class="space-y-3 ">
                ...
                <a class="flex transform items-center rounded-lg px-3 py-2 text-gray-600 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700"
                  href="category.php">
                  <img width="15" height="15" src="https://img.icons8.com/ios-filled/20/opened-folder.png"
                    alt="opened-folder" />
                ...
                <a class="flex transform items-center rounded-lg px-3 py-2 text-gray-600 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700"
                  href="state.php">
                  <img width="20" height="20" src="https://img.icons8.com/material/15/region-code.png"
                    alt="region-code" />
              ...
              <div class="space-y-3 ">
                ...
                <a class="flex transform items-center rounded-lg px-3 py-2 text-gray-600 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700"
                  ...
                  <img width="20" height="20" src="https://img.icons8.com/ios-filled/20/conference-call.png"
                    alt="conference-call" />
            ...
            <div class="mt-6">
              <div class="rounded-lg bg-gray-300 p-3 ">
                ...
                <img class="mt-2 h-32 w-full rounded-lg object-cover" src="https://images.app.goo.gl/ZqZYQQ2qzNMrLfbE8"
                  alt="Feature" />
              </div>
              <div class="mt-6 flex items-center justify-between">
                <a href="#" class="flex items-center gap-x-2">
                  <img class="h-7 w-7 rounded-full object-cover"
                    src="https://img.icons8.com/glyph-neue/64/administrator-male.png" alt="avatar" />
