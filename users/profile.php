    ...
    <section id="container">
      ...
      <section id="main-content">
        <section class="wrapper">
          <h3><i class="fa fa-caret-right" aria-hidden="true"></i> User information</h3>
              ...
              <div class="form-panel">
                ...
                <?php if ($successmsg) { ?>
                  <div class="alert alert-success alert-dismissable">
                    ...
                    <b>Update done!</b> <?php echo htmlentities($successmsg); ?>
                  </div>
                <?php } ?>
                      ...
                      <div class="col-sm-4">
                        <select name="state" required="required" class="form-control">
                          <option value="<?php echo htmlentities($row['State']); ?>">
                            <?php echo htmlentities($st = $row['State']); ?></option>
