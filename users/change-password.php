...
<html lang="en">
  <head>
    ...
    <title>Nyayaprabha | User Change Password</title>
...
return true;
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-caret-right" aria-hidden="true"></i> Change Password</h3>
          	
          	<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-caret-right" aria-hidden="true"></i> User Change Password</h4>

                      <?php if($successmsg)
                      {?>
                      <div class="alert alert-success alert-dismissable">
                       <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      <b>Passward Change!</b> <?php echo htmlentities($successmsg);?></div>
                      <?php }?>
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      <b>Sorry!</b> </b> <?php echo htmlentities($errormsg);?></div>
                      <?php }?>
